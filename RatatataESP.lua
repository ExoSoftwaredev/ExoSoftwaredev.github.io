...
if not syn and not PROTOSMASHER_LOADED then print'Ratatata ESP only officially supports Synapse and Protosmasher!' end
...
local LastRefresh = 0
local OptionsFile = 'ESP_SETTINGS.dat'
local Binding = false
local BindedKey = nil
local OIndex = 0
local LineBox = {}
...
shared.RSName = shared.RSName or ('RatatataESP_by_Anon' .. HttpService:GenerateGUID(false))
